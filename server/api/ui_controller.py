...
def drawer():
    ...
    response = make_response(render_template('drawer.html', drawer_button=server_config.app.drawer_button, eraser_button=server_config.app.eraser_button))
...
def display():
    ...
    return render_template('viewer.html', drawer_button=server_config.app.drawer_button, eraser_button=server_config.app.eraser_button)
